...
int main()
{
    ...
    int opcao, opcao_cliente, opcao_pesquisar, opcao_automovel, resulNovoCliente, Idcliente, resulA, IDauto, tlm, ANO, ANOPOSTERIOR;
    string chassi;
    do
    {
